    ...
    attach: function (context, settings) {
      ...
      $(window).once('backToTopShowButtonHandler').on('scroll', function () {
        ...
        if (scrollPos > showHeight && !isAttached) {
          ...
          $('.layout__region--main', context).append(`<div id="back-to-top" class="btn btn-lg btn-dark zindex-popover position-fixed bottom-0 end-0 mb-3" style="margin: 9rem;"><a class="link-light" href="#header">${buttonText}</a></div>`);
          isAttached = true;
